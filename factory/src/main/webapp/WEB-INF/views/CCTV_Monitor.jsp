<%@page import="com.smhrd.demo.model.IncidentModel"%> <%@page
    ...
    <div alt="전역 컨테이너" class="container">
      ...
      <div id="secondary-modal-video" class="hidden">
        <div class="modal-contents">
          <span class="close-secondary-modals" style="cursor: pointer"
            >&times;</span
          >
          <!-- 닫기 버튼 추가 -->
