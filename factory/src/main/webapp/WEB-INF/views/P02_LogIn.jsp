...
<body>
    <div class="login-container">
        <div class="login-box">
            ...
            <form  alt="로그인 페이지 컨테이너-form" id="logInForm" method="post" action= "/LoginFrom" class="enterForm">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="pw" placeholder="Enter password" required>
                </div>
